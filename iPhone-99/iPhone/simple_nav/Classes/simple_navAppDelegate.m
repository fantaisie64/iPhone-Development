...
#import "simple_navAppDelegate.h"
#import "myViewControllerA.h"

@implementation simple_navAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	[myNav pushViewController:myViewConA animated:YES];
	[window addSubview:myNav.view];
